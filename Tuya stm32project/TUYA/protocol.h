...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "xt4hnpfwgwqtzazf"    //开发平台创建产品后生成的16位字符产品唯一标识
...
#define WIFI_UART_RECV_BUF_LMT          1024//16              //串口数据接收缓存区大小,如MCU的RAM不够,可缩小
#define WIFI_DATA_PROCESS_LMT           1024//24              //串口数据处理缓存区大小,根据用户DP数据大小量定,必须大于24
#else
...
//屏保开关(可下发可上报)
//备注:屏幕壁纸开关
#define DPID_SCREEN 101
//自动亮度(可下发可上报)
//备注:自动亮度开关
#define DPID_LIGHT 102
//灯模式(可下发可上报)
//备注:灯模式开关
#define DPID_LED_MODE 103
